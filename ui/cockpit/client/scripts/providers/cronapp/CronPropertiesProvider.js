...
var serviceTaskDelegateProps = require('bpmn-js-properties-panel/lib/provider/camunda/parts/ServiceTaskDelegateProps'),
  ...
  cronProps = require('./parts/cronProps');
...
function createCronTabGroups(element) {

  // Create a group called "Cronapp Specific".
  var cronappGroup = {
    id: 'cronapp',
  ...
  // Add the spell props to the cronapp group.
